...
import libSVMUtils.dto.Anchor;
import libSVMUtils.dto.HigherAnchorDTO;
...
public class test {
	...
	private static String trainXPathNameTemp = "resources/indoor_train_x_%d_%s.data";
	private static String trainYPathNameTemp = "resources/indoor_train_y_%d_%s.data";
	private static String testXPathNameTemp = "resources/indoor_test_x_%d_%s.data";
	private static String testYPathNameTemp = "resources/indoor_test_y_%d_%s.data";
	private static String modelXPathTemp = "resources/indoor_model_x_%d_%s.model";
	private static String modelYPathTemp = "resources/indoor_model_y_%d_%s.model";
	private static String outputXPathTemp = "resources/indoor_output_x_%d_%s.model";
	private static String outputYPathTemp = "resources/indoor_output_y_%d_%s.model";
	private static String resultXPathTemp = "resources/indoor_result_x_%d_%s.model";
	private static String resultYPathTemp = "resources/indoor_result_y_%d_%s.model";
	...
	private static void testWebInterface() throws ClientProtocolException,
		...
		try {
			...
			if (response.getStatusLine().getStatusCode() == 200) {
				...
				int row = 0;
				for (Anchor anchor : han.getAnchors()) {
